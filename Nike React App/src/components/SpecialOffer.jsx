    ...
    <section className="flex items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-col flex-1">
        ...
        <p className="mt-4 info-text lg:max-w-lg"> 
          Embark on a shopping journey that redifines your experience with unbeatable deals. From 
          premier selections to incredible savings, we offer unparalleled value that sets us apart.
        </p>

        <p className='mt-6 info-text lg:max-w-lg'> 
          Navigate a realm of possibilities design to fulfill your unique desires, surpassing the loftiest
